          ...
          <tbody>
            <tr>
              ...
              <span style="color: #8f8f8f; font-weight: normal; line-height: 2; font-size: 14px;">
                  Media : hhhhhhhhhhhhhhhhh</span>
              </td>
              <td align="right" valign="center"
                style="padding-bottom:40px;border-top:0;height:100% !important;width:100% !important;">
                <span style="color: #8f8f8f; font-weight: normal; line-height: 2; font-size: 14px;">Date de publication : dfhfdhfdhfdhfdhfdh</span>
              </td>
            </tr>
            <tr>
              <td colSpan="2" style="padding-top:10px;border-top:1px solid #e4e2e2">
                <h2 style="color:#303030; font-size:18px; line-height: 1.6; font-weight:500;">fghfdghdfhfh</h2>
             dfhdfhfdhfghfh
              </td>
            </tr>
          </tbody>
